...
@section('extendCss')
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                ...
                                <tbody>
                                <tr class="" id = "account1">
                                    <td>赵冲</td>
                                    <td>18868112323</td>
                                    <td>超级管理员</td>
                                    <td>20140812 13:34:45</td>
                                    <td><a class="edit" href="javascript:;">编辑</a></td>
                                    <td><a class="delete" href="javascript:;">删除</a></td>
                                </tr>

                                <tr class="hello" id='account2'>
                                    <td>向昶宇</td>
                                    <td>18868101152</td>
                                    <td>超级管理员</td>
                                    <td>20130613 16:34:12</td>
                                    <td><a class="edit" href="javascript:;">编辑</a></td>
                                    <td><a class="delete" href="javascript:;">删除</a></td>
                                </tr>
    ...
    <script src="js/zqj_account.js"></script>
    <script>
